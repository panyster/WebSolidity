...
#[derive(Debug)]
pub struct WebSolidityProcessor {
    verbose: bool,
    processed_count: usize,
}

impl WebSolidityProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting WebSolidity processing");
    
    let mut processor = WebSolidityProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = WebSolidityProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = WebSolidityProcessor::new(false);
